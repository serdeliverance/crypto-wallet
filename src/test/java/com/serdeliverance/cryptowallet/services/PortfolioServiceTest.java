...
public class PortfolioServiceTest {
                ...
                .thenReturn(
                        asList(
                                ...
                                new Transaction(
                                        ...
                                        BigDecimal.ONE,
                                        BUY,
                                        "2021-02-06T19:29:03.239")));
        when(cryptocurrencyService.quotes())
                .thenReturn(
                        asList(
                                new CurrencyQuoteDTO(
                                        "Bitcoin", BigDecimal.valueOf(48081.979491230726)),
                                new CurrencyQuoteDTO(
                                        "Ethereum", BigDecimal.valueOf(1810.264184795378)),
                                new CurrencyQuoteDTO(
                                        "Tether", BigDecimal.valueOf(1.00048112681234)),
                                new CurrencyQuoteDTO(
                                        "Cardano", BigDecimal.valueOf(0.87957104579375))));
    ...
    void whenUserHasTransactionsWithMultipleCurrenciesItShouldReturnPorfolio() {
                ...
                .thenReturn(
                        asList(
                                new Transaction(
                                        ...
                                        "2021-02-05T19:29:03.239"),
                                new Transaction(
                                        26L, 1, 1, BigDecimal.ONE, BUY, "2021-02-06T19:29:03.239"),
                                new Transaction(
                                        27L, 1, 2, BigDecimal.ONE, BUY, "2021-02-06T19:29:03.239"),
                                new Transaction(
                                        34L,
                                        1,
                                        3,
        ...
        // then
        CurrencyTotalDTO expectedBitcoinTotal =
                new CurrencyTotalDTO("Bitcoin", BigDecimal.valueOf(3));
        CurrencyTotalDTO expectedEthereumTotal =
                new CurrencyTotalDTO("Ethereum", BigDecimal.valueOf(2));
        CurrencyTotalDTO expectedTetherTotal =
                new CurrencyTotalDTO("Tether", BigDecimal.valueOf(2));

        BigDecimal expectedBitcoinInUsd = expectedBitcoinTotal.getAmount().multiply(bitcoinQuote);
        BigDecimal expectedEthereumInUsd =
                expectedEthereumTotal.getAmount().multiply(ethereumQuote);
    ...
    public void whenUserHasNotEnoughFundsValidateShouldThrowException() {
        ...
        when(transactionRepository.getByUser(2))
                .thenReturn(
                        asList(
                                new Transaction(
                                        23L, 2, 1, BigDecimal.ONE, BUY, "2021-02-05T19:29:03.239"),
                                new Transaction(
                                        26L, 2, 1, BigDecimal.ONE, BUY, "2021-02-06T19:29:03.239"),
                                new Transaction(
                                        27L,
                                        2,
                                        1,
